(function(global, factory) {
	typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.nodeHTMLParser = {}));
			...
			if (!leadingSlash) {
				...
				if (is_block_text_element(tagName)) {
					...
					if (element_should_be_ignore(tagName)) {
						...
						if (text.length > 0 && /\S/.test(text)) currentParent.appendChild(new TextNode(text, null, createRange(tagEndPos, textEndPos)));
					}
